    ...
    return (
        <section id="story" className="min-h-dvh w-screen bg-black ">
            ...
            ">
                ...
                md:text-[10px] text-white">The multiversal ip world</p>
                ...
                <div className="flex w-full justify-center md:-mt-28  md:justify-end">
                    <div className="flex h-full w-fit flex-col items-center md:items-start">
                        <p className="mt-3 max-w-sm text-center font-circular-web text-violet-50 md:text-start pr-5">
